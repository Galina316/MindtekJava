...
public class Mindtek {
    public static void main(String[] args) {
        ...
        List<String> javaClasses =  new ArrayList<>(List.of("Java","Java Stream","Java Generics","Spring boot","Git","Unit Test","Clouds"));
        ...
        System.out.println("==========");
        // John doe is attending Java development programm
