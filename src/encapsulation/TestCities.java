...
public class TestCities {
    public static void main(String[] args) {
        ...
        /*
    Write a method that takes arrays of cities and country name as parameters
    and method returns total population of cities of that countries
    Ex:
    ...
    /*
    Write a method that will take region as parametr
